...
public class FileController extends BaseController {
    ...
    public void getFile(@RequestParam Integer fileId, @RequestParam Integer down, HttpServletRequest request, HttpServletResponse response) {
    ...
    public void deleteFile(@RequestParam Integer refId, @RequestParam Integer type, HttpServletResponse response) {
        try {
            ...
            printJson(ResultUtil.success(fileEntityList), response);
        } catch (Exception e) {
            e.printStackTrace();
            printJson(ResultUtil.error(-1, e.getMessage()), response);
        }
